...
int SCRFD::load(const char *modeltype, bool use_gpu)
{
    ...
    facept.load_param("./models/facemesh-op.param");
    facept.load_model("./models/facemesh-op.bin");
    ...
    char parampath[256];
    char modelpath[256];
    sprintf(parampath, "./models/scrfd_%s-opt2.param", modeltype);
    sprintf(modelpath, "./models/scrfd_%s-opt2.bin", modeltype);
